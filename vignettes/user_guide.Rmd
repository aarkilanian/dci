...
In the example below the DCI is calculated for a potamodromous species with a dispersal limit of 1,200m. No weighting is used in this case.
```{r}
...
A convenient 'export_dci' function is included in this package to simplify the exporting of dci results in a simple format. The functionality of this code is presented below.
```{r}
