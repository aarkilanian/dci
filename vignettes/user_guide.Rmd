...
```{r}
# Import barriers
barriers_in <- import_points(system.file("extdata/yam_bar.shp", package = "dci"), type = "barriers")
outlet_in <- import_points(system.file("extdata/yam_out.shp", package = "dci"), type = "outlet")
poi_in <- import_points(system.file("extdata/yam_poi.shp", package = "dci"), type = "poi")
barriers_in
```
