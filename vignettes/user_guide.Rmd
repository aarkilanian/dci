...
yamaska_riv <- readRDS("../data/yamaska_riv")
...
```{r}
# Loading sf objects
yamaska_bar <- readRDS("../data/yamaska_bars")
yamaska_outlet <- readRDS("../data/yamaska_outlet")
yamaska_poi <- readRDS("../data/yamaska_poi")
